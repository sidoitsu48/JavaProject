...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 26. Sep 2018 um 08:24
...
--
-- Datenbank: `adressendb`
--
CREATE DATABASE IF NOT EXISTS `adressendb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `adressendb`;
...
CREATE TABLE `adressen` (
  `adrindex` int(11) NOT NULL,
  `name` varchar(256) NOT NULL COMMENT 'Vornamen+Nachnamen',
  `strasse` varchar(256) NOT NULL,
  `plz` varchar(5) NOT NULL,
  `stadt` varchar(256) NOT NULL,
  `email` varchar(256) NOT NULL,
  `telefon` varchar(11) NOT NULL,
  `kunde` tinyint(1) DEFAULT NULL,
  `mitarbeiter` tinyint(1) DEFAULT NULL,
  `lieferant` tinyint(1) DEFAULT NULL
...
--
ALTER TABLE `adressen`
  MODIFY `adrindex` int(11) NOT NULL AUTO_INCREMENT;
--
-- Datenbank: `foodshop`
--
CREATE DATABASE IF NOT EXISTS `foodshop` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `foodshop`;
...
INSERT INTO `foods` (`foodno`, `name`, `price`) VALUES
(0, 'Pizza Currywurst', 7.76),
(1, 'Spagetti', 5.3),
(2, 'Pizza Margaritta Java', 8.5),
(3, 'Pizza Tonno', 7.85),
(4, 'Pizza Hawai 05', 5.5),
(5, 'Pizza Toscana', 6.5),
(6, 'Pizza Callzone', 5.75),
(9, 'Pizza Schokolade', 6.45);
...
--
ALTER TABLE `foods`
  MODIFY `foodno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
('root', '[{\"db\":\"adressendb\",\"table\":\"adressen\"},{\"db\":\"foodshop\",\"table\":\"foods\"}]');
...
('root', '2018-09-26 06:17:15', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"de\"}');
